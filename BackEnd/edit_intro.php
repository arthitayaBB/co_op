...
if (isset($_POST['Submit'])) {
    ...
    // อัปเดตข้อมูล พร้อมบันทึกผู้แก้ไข
    $updateSql = "UPDATE intro SET I_detail = '$I_detail', I_status = $I_status, Admin_id = $Admin_id WHERE Intro_id = $Intro_id";
    ...
    mysqli_close($conn);
    echo "<script>alert('แก้ไขข้อมูลสำเร็จ'); window.location='indexintro.php';</script>";
    exit();
}
?>
